...
public class EmployeeBonusProfileController
    ...
    @Override
    public ResponseEntity<?> bulkSave(List<EmployeeBonusProfileRequest> requests) {

        List<EmployeeBonusProfileResponse> result = bonusProfileService.bulkSave(requests);
