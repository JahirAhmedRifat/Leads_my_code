...
public class YearlyBonusSetupController
    ...
    @Override
    public ResponseEntity<?> findByBonusYearAndType(YearlyBonusSetupSearchRequest request) {
        YearlyBonusSetupResponse result = yearlyBonusSetupQueryService.findByBonusYearAndType(
                request
        );
