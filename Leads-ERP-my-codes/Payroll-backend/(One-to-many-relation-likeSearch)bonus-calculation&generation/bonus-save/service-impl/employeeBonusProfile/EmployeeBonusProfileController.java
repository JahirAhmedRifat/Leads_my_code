...
@ApiController
@RequestMapping("employee-bonus-profile")
public class EmployeeBonusProfileController
    ...
    @Override
    public ResponseEntity<?> getDataForBonusDisbursement(EmployeeBonusProfileSearchRequest request) {

        PageResponse<EmployeeBonusProfileResponse> result = profileQueryService.getDataForBonusDisbursement(request);
